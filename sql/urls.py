...
urlpatterns = [
    ...
    path("check/siliconflow_models/", views.siliconflow_models),
    ...
    path("ai_dict/table_meta/", ai_dictionary.table_meta),
    path("ai_dict/save/", ai_dictionary.save),
    path("ai_dict/list/", ai_dictionary.lists),
    path("ai_dict/template_list/", ai_dictionary.template_list),
    path("ai_dict/template_preview/", ai_dictionary.template_preview),
    path("ai_dict/ai_execute/", ai_dictionary.ai_execute),
    path("ai_dict/save_query_template/", ai_dictionary.save_query_template),
    path("ai_dict/delete_query_template/", ai_dictionary.delete_query_template),
    path("ai_dict/delete/", ai_dictionary.delete),
    ...
    path("query/ai_dict_options/", query.ai_dict_options),
    path("query/ai_template_options/", query.ai_template_options),
